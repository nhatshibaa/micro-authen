...
public interface KeycloakService {
    ...
    boolean addRealmRoleById(String id, RoleRepresentation[] roleRepresentations) throws IOException;
    boolean addClientRoleById(String id,String client, ClientRoleRepresentation[] clientRoleRepresentations) throws IOException;
